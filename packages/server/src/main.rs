...
use rest_handler::third_party::discord::{
    create_discord_guild, create_discord_message, create_discord_thread, delete_discord_message,
    delete_discord_thread, get_discord_message, get_discord_thread, list_discord_message,
    list_discord_threads,
};
...
async fn main() {
    ...
    let http = Router::new()
        ...
        .route("/discord/threads", axum::routing::get(list_discord_threads))
        .route(
